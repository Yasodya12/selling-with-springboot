...
export function UpdateListing() {
    ...
    useEffect(() => {
        const fetchListing = async () => {
            ...
            const res = await fetch(`http://localhost:4000/server/listing/get/${listingId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLoading(true);
            setError(false);
            const res = await fetch(`http://localhost:4000/server/listing/update/${params.listingId}`, {
                method: 'POST',
                headers: {
